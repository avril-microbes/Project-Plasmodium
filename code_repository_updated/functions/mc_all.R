...
mc_all <- function(par, cue, cue_range, log, rand_df){
  ...
  # write files
  write.csv(fitness.df, here(paste0("code_repository_updated/data/mc_all_fitness/", cue, "_", log, "_", id, ".csv")))
  arrow::write_parquet(x = dyn_f, sink = here(paste0("code_repository_updated/data/mc_all_dyn/", cue, "_", log, "_", id, ".parquet")))
}