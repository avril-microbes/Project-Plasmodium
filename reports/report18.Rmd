...
#double check Total\ngametocyte log10. have 0
test <- chabaudi_ci_clean(parameters_cr_1 = c(12.106219, -21.043524 , -5.010265, -16.928459),
...
# plot. Co-infection leads to lower average conversion rate over course of infection. Even when co-infetion strategy is in single infection, we still see lower conversion rate.
```{r}
