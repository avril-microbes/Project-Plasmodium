...
# total gametocyte
```{r}
ci_G1_G2_opt <- co_infection_opt_alt(parameters_cr = c(3.05668, -5077.22092,   585.42826, -8703.57817),
                             limit = 0.01,
                             model = chabaudi_ci_clean,
                             immunity = "tsukushi",
                             parameters = parameters_tsukushi,
...
```{r}
ci_Ig1_Ig2_log_opt <- co_infection_opt_alt(parameters_cr = c(75.73915, -128.01549,  -41.16782,  -96.21549),
                             limit = 0.01,
                             model = chabaudi_ci_clean,
                             immunity = "tsukushi",
                             parameters = parameters_tsukushi,
