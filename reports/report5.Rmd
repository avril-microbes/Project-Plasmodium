...
fig1d <- ggplot(invasion_fitness.df) +
  geom_line(aes(x = date, y = fitness)) +
  labs(y = "Strain 1 fitness", x = "Invasion date") +
  theme_bw()
```
...
fig <- ggarrange(fig1ab, fig1cd, align = "hv", ncol = 1)
ggsave(here("figures/report5/delayed_fitness.png"), width = 10, height = 7)
```
...
```{r}
cl <- makeCluster(detectCores()); setDefaultCluster(cl = cl)
lag_ci_I_20.opt_tsukushi_I_r075 <- optimParallel(par = c(0.5, 0.5, 0.5, 0.5),# new parameter search space
                      fn = chabaudi_ci_opt_lag, 
                      control = list(trace = 6, fnscale = -1),
                      immunity = "tsukushi",
                      parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250),
...
#4.827418  12.375272 -12.823415  -2.188946
#-0.01667986

lag_ci_I_20.dyn_tsukushi_I_r075 <- chabaudi_ci_opt_lag(
  parameters_cr_1 = c(4.827418,  12.375272, -12.823415,  -2.188946), 
  parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250), 
  immunity = "tsukushi",
  parameters = parameters_tsukushi,
  time_range = seq(0, 20, by = 1e-3),
...
#4.820398  12.367664 -12.806448  -2.186764
#-0.01669244

lag_ci_I_20.dyn_tsukushi_I_r05 <- chabaudi_ci_opt_lag(
  parameters_cr_1 = c(4.820398,  12.367664, -12.806448 , -2.186764), 
  parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250), 
  immunity = "tsukushi",
  parameters = parameters_tsukushi,
  time_range = seq(0, 20, by = 1e-3),
...
#-0.01670426
#4.826335  12.361212 -12.813530  -2.191649

lag_ci_I_20.dyn_tsukushi_I_r025 <- chabaudi_ci_opt_lag(
  parameters_cr_1 = c(4.826335,  12.361212, -12.813530 , -2.191649), 
  parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250), 
  immunity = "tsukushi",
  parameters = parameters_tsukushi,
  time_range = seq(0, 20, by = 1e-3),
...
```{r}
cl <- makeCluster(detectCores()); setDefaultCluster(cl = cl)
lag_ci_I_20.opt_tsukushi_I_r01 <- optimParallel(par = c(0.5, 0.5, 0.5, 0.5),# new parameter search space
                      fn = chabaudi_ci_opt_lag, 
                      control = list(trace = 6, fnscale = -1),
                      immunity = "tsukushi",
                      parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250),
...
#0.00375488
#568.0285 -744.8686 -512.1939 -585.4138

lag_ci_I_20.dyn_tsukushi_I_r01 <- chabaudi_ci_opt_lag(
  parameters_cr_1 = c(568.0285, -744.8686, -512.1939, -585.4138), 
  parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250), 
  immunity = "tsukushi",
  parameters = parameters_tsukushi,
  time_range = seq(0, 20, by = 1e-3),
...
ggplot() +
  geom_line(data = lag_ci_I_20.dyn_tsukushi_I_r01, aes(x = time, y = value, color = strain)) +
  facet_wrap(~variable_alt, scales = "free", ncol = 4) +
  labs(x = "Time post-infection (days)",
         y = "Values",
         color = "") +
...
```{r}
cl <- makeCluster(detectCores()); setDefaultCluster(cl = cl)
lag_ci_I_20.opt_tsukushi_I_r001 <- optimParallel(par = c(0.5, 0.5, 0.5, 0.5),# new parameter search space
                      fn = chabaudi_ci_opt_lag, 
                      control = list(trace = 6, fnscale = -1),
                      immunity = "tsukushi",
                      parameters_cr_2 = c(360.3151, -470.3701, -325.4047, -371.3250),
...
# get reaction norm
```{r}
lag_ci_I_20.par_tsukushi_I_r075 <- par_to_df(c(4.827418,  12.375272, -12.823415,  -2.188946),I_range_mid4_log10)

lag_ci_I_20.par_tsukushi_I_r05 <- par_to_df(c(4.820398,  12.367664, -12.806448 , -2.186764),I_range_mid4_log10)

lag_ci_I_20.par_tsukushi_I_r025 <- par_to_df(c(4.826335,  12.361212, -12.813530 , -2.191649),I_range_mid4_log10)

lag_ci_I_20.par_tsukushi_I_r01 <- par_to_df(c(568.0285, -744.8686, -512.1939, -585.4138),I_range_mid4_log10)
...
```{r}
fig2 <- ggarrange(fig2a, fig2b, align = "hv", labels=c("A","B"), common.legend = TRUE)
ggsave(here("figures/report5/dilution.png"))
```
...
fig3a <- ggplot() +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr0_11, aes(x = cue_range, y = cr, color = "0 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr2_11, aes(x = cue_range, y = cr, color = "2 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr4_11, aes(x = cue_range, y = cr, color = "4 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr6_11, aes(x = cue_range, y = cr, color = "6 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr8_11, aes(x = cue_range, y = cr, color = "8 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr10_11, aes(x = cue_range, y = cr, color = "10 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr12_11, aes(x = cue_range, y = cr, color = "12 mg/kg")) +
  geom_line(data = lag_si_I_20.par_tsukushi_pyr14_11, aes(x = cue_range, y = cr, color = "14 mg/kg")) +
...
ggsave(here("figures/report5/pyr_11.png"), width = 7, height = 3)
```
...
# 2 mg/kg
cl <- makeCluster(detectCores()); setDefaultCluster(cl = cl)
lag_si_I_20.opt_tsukushi_pyr2_5 <- optimParallel(par = rep(0.5,4),# new parameter search space
                      fn = chabaudi_si_opt_lag, 
                      control = list(trace = 6, fnscale = -1),
                      immunity = "tsukushi",
                 parameters = parameters_tsukushi,
