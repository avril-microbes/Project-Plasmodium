...
fig2c <- ggplot() +
  geom_line(data = lag_ci_I_20.cr_log_tsukushi, aes(x = cue_range, y = cr, color = "Co-infection")) +
  geom_line(data = lag_si_I_20.cr_log_tsukushi, aes(x = cue_range, y = cr, color = "Single infection")) +
...
# plot
ggplot(lag_si_I_20.opt_tsukushi_cycle) +
  geom_line(aes(x = index, y = par_1, color = "par 1")) +
  geom_line(aes(x = index, y = par_2, color = "par 2")) +
  geom_line(aes(x = index, y = par_3, color = "par 3")) +
  geom_line(aes(x = index, y = par_4, color = "par 4")) +
  theme_bw()
```
...
ggarrange(fig2a, fig2b, fig2c, align = "hv", labels = c("A", "B", "C"))
```
