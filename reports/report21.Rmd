...
# testing 2 versions of dual cue. Te full tensor product interaction or ti only product interaction with no main term effect 
...
ti_fun <-  function(
  ...
  chabaudi_si_dyn <- function(t, state, parameters){
    ...
    if(t>alpha+delay){
      ...
      if(cue_b != "none"){cr <- cr_fun(cue_lag1_p, cue_lag1_p_b)}
