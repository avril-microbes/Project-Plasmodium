...
```{r}
# get list of interested variables for plotting. drop cr, fitness, and death probability, immunity
dual_var.ls <- unique(dual.cr$variable)[!unique(dual.cr$variable) %in% c("tau", "tau_cum", "cr", "cr_t", "ID", "N", "W")]

# create all possible variable combinations. 28 variable combination (8*8 with 8 same redundant and half of that) is expected
