#-----------------------#
# Single infection model of Plasmodium chabaudi with no immunity (Tsukukshi model)
# Avril Wang
# Last edited 2022-07-11. Based on the 2022-06-22 iteration of chabaudi_si_clean.R
# dual cue cable
#-----------------------#

chabaudi_si_clean_NW <- function(
