#-----------------------#
# Single infection model of Plasmodium chabaudi without targeted immunity
# Avril Wang
# Last edited 2022-06-11. Based on 2022-06-22 iteration of chabaudi_si_clean.R
# dual cue cable
#-----------------------#

chabaudi_si_clean_W <- function(
