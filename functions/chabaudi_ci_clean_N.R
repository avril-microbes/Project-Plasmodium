...
#-------------------#
# derivative of 2022-05-28 version of chabaudi_ci_clean.R
# no indiscriminant immunity (N)
...
chabaudi_ci_clean_N <- function(parameters_cr_1, # parameters for strain 1 conversion rate strategy
