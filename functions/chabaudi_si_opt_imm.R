# Test functions for integrating different immune functions
...
chabaudi_si_opt_imm <- function(parameters_cr, immunity, parameters, time_range, df, cue, cue_range, solver = "lsoda", dyn = FALSE, innate = "default"){
  #-------------------------#
