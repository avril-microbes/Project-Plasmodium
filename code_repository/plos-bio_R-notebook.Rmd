...
# R and I log
mc_R_I_log.res <- mclapply(posterior.ls, function(x){
...
# R and I log
mclapply(posterior.ls[1200:length(posterior.ls)], function(x){
...
## run function
lapply(dual_cue_burst.ls, function(x){dual_cue_opt_beta(x)})
lapply(dual_cue_burst.ls, function(x){dual_cue_opt_beta(x, default = T)})
```
