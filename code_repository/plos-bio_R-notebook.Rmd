...
source(here("functions/ci_comp_static.R"))

# for invasive competition
source(here("functions/ci_invasion_analysis.R"))

# for partitioning analysis
source(here("functions/partition_si.R"))

# for semi-stochastic single infection model
source(here("functions/mc_run.R")) ## 1000 MC simulations of single infection model where all 6 parameters vary
source(here("functions/mc_five.R")) ## wrapper around mc_run to simulate 5000 MC simulations. Avoid memory overload
source(here("function/partition_var.R")) ## performs 1000 MC simulations of the single infection model where only one specified parameter vary
source(here("function/mc_five2.R")) ## wrapper around partition_var to perform 5000 simulations
source(here("functions/get_par_MC.R")) ## wrapper around mc_five2 to execute all 6 iterations of 5000 simulations where only one parameter vary
```
