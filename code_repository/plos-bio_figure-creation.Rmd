...
ggplot() +
  geom_line(data = dual_selected_taucum.df_p, aes(color = label_new, x = time, y = fitness_norm), size = 1) +
  geom_point(data = dual_selected_taucum.df_p %>% filter(time%%1 == 0), aes(color = label_new, x = time, y = fitness_norm, shape = label_new), size = 3) +
